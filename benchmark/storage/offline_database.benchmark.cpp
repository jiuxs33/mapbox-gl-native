...
public:
    void SetUp(const ::benchmark::State&) override {
        ...
        for (unsigned i = 0; i < tileCount; ++i) {
            const Resource ambient = Resource::tile("mapbox://tile_ambient" + i, 1, 0, 0, 0, Tileset::Scheme::XYZ);
        ...
        for (unsigned i = 0; i < tileCount; ++i) {
            const Resource offline = Resource::tile("mapbox://tile_offline_region" + i, 1.0, 0, 0, 0, Tileset::Scheme::XYZ);
